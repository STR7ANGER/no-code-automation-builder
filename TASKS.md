...
- [x] 10. Design draft/version/publish lifecycle and GraphQL workflow query layer; write acceptance criteria, contracts, risks, and the smallest vertical slice.
...
- [x] 28. Design failure-injection/E2E tests, security review, demo automations, and deployment docs; write acceptance criteria, contracts, risks, and the smallest vertical slice.
- [x] 29. Implement failure-injection/E2E tests, security review, demo automations, and deployment docs; keep frontend, API, domain logic, workers, and persistence in their declared boundaries.
- [x] 30. Verify failure-injection/E2E tests, security review, demo automations, and deployment docs with tests, failure cases, telemetry, documentation, and a reviewable demo.
